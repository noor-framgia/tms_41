...
# UserTask.create! user_id:3, task_id:9
# UserTask.create! user_id:3, task_id:10
# for generating progress
# UserCourse.create(user_id:3, course_id:1)
# UserSubject.create(user_id:3, course_subject_id:1, status:1)
# UserSubject.create(user_id:3, course_subject_id:2, status:1)
# UserSubject.create(user_id:3, course_subject_id:3, status:1)
